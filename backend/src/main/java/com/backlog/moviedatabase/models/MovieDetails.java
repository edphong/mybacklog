...
public class MovieDetails {
    ...
    // Getters and setters for MovieDetails class
    ...
    public void setBelongs_to_collection(String belongs_to_collection) { this.belongs_to_collection = belongs_to_collection; }
    ...
    public static class ProductionCountry {
        private String iso_3166_1; // codes for countries
        private String name;
